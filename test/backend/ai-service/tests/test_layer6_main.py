...
class TestMainLifespan:
    ...
    @patch("app.main.set_embedding_model")
    @patch("app.main.set_rerank_model")
    @patch("app.main.serve_grpc")
    ...
    async def test_lifespan_startup_and_shutdown(
        ...
        mock_init_worker,
        mock_serve_grpc,
        mock_set_rerank_model,
        mock_set_embedding_model,
        ...
        mock_ai_client.return_value.close = AsyncMock()
        mock_redis_client.return_value.close = AsyncMock()
        
        # 模拟 serve_grpc 任务
        mock_serve_grpc_task = asyncio.Future()
        mock_serve_grpc.return_value = mock_serve_grpc_task
        ...
        async with lifespan(app):
            ...
            assert app.state.ai_client == mock_ai_client.return_value
            ...
            mock_set_embedding_model.assert_called_once_with("embedding_model")
            mock_set_rerank_model.assert_called_once_with("rerank_model")
        ...
        mock_ai_client.return_value.close.assert_called_once()
