...
class ModelConfig(_message.Message):
    __slots__ = ("base_url", "api_key", "model_id", "max_tokens", "temperature")
    ...
    max_tokens: int
    temperature: float
    def __init__(self, base_url: _Optional[str] = ..., api_key: _Optional[str] = ..., model_id: _Optional[str] = ..., max_tokens: _Optional[int] = ..., temperature: _Optional[float] = ...) -> None: ...
