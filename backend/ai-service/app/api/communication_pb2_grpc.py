...
class CommunicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Rerank = channel.unary_unary(
                ...
                _registered_method=True)
        self.InputReconstruction = channel.unary_unary(
                '/communication.CommunicationService/InputReconstruction',
                request_serializer=communication__pb2.InputReconstructionRequest.SerializeToString,
                response_deserializer=communication__pb2.InputReconstructionResponse.FromString,
                _registered_method=True)
...
class CommunicationServiceServicer(object):
    ...
    def InputReconstruction(self, request, context):
...
def add_CommunicationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'InputReconstruction': grpc.unary_unary_rpc_method_handler(
                    servicer.InputReconstruction,
                    request_deserializer=communication__pb2.InputReconstructionRequest.FromString,
                    response_serializer=communication__pb2.InputReconstructionResponse.SerializeToString,
            ),
    }
...
class CommunicationService(object):
    ...
    @staticmethod
    def InputReconstruction(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/communication.CommunicationService/InputReconstruction',
            communication__pb2.InputReconstructionRequest.SerializeToString,
            communication__pb2.InputReconstructionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
