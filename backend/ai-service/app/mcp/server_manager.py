...
class MCPServerConfigModel(BaseModel):
    ...
    transport_type: str = Field("sse", description="传输协议: sse/stdio (这里仅支持sse)")
...
class MCPServerManager:
    ...
    async def initialize(self, pg_client: PostgresClient):
        ...
        await self._load_from_yaml(pg_client)
    ...
    async def _load_from_yaml(self, pg_client: PostgresClient):
            ...
            for server_data in yaml_data["mcp_servers"]:
                ...
                async with pg_client.session() as session:
                    ...
                    if existing:
                        ...
                        existing.transport_type = server_data.get("transport_type", "sse")
                        ...
                        new_config = MCPServerConfig(
                            ...
                            transport_type=server_data.get("transport_type", "sse"),
