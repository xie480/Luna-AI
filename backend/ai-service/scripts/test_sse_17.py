...
async def test():
    ...
    async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
        ...
        # Try a different way to formulate the SSE URL. 
        # From earlier tests, base_url/connect/{namespace}/{server_id} works for tools.
        # But SSE needs /sse
        mcp_url = f"{base_url}/connect/{namespace}/youtube/sse"
