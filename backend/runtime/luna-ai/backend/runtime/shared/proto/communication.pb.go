...
type ModelConfig struct {
	...
	MaxContextTokens int32                  `protobuf:"varint,6,opt,name=max_context_tokens,json=maxContextTokens,proto3" json:"max_context_tokens,omitempty"` // 上下文窗口最大 Token 数
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_communication_proto_rawDesc = "" +
	...
	"\x05error\x18\x06 \x01(\tR\x05error\"\xcb\x01\n" +
	...
	"\x12max_context_tokens\x18\x06 \x01(\x05R\x10maxContextTokens\"\x96\x02\n" +
