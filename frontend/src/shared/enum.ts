...
export const WS_MSG_TYPE = {
  ...
  CMD_PAUSE_TASK: "CMD_PAUSE_TASK",
  CMD_RESUME_TASK: "CMD_RESUME_TASK",
  ...
  // === Phase 10：任务状态机与中断恢复 ===
  // Python -> Electron: 任务状态机事件
  EVT_TASK_PAUSED: "EVT_TASK_PAUSED",
  EVT_TASK_RESUMED: "EVT_TASK_RESUMED",
  EVT_TASK_TIMEOUT: "EVT_TASK_TIMEOUT",
  EVT_TASK_RECOVERY_STARTED: "EVT_TASK_RECOVERY_STARTED",
  EVT_TASK_RECOVERY_COMPLETED: "EVT_TASK_RECOVERY_COMPLETED",
  EVT_TASK_RECOVERY_FAILED: "EVT_TASK_RECOVERY_FAILED",
  ...
  // === 长回答 (Long Answer) 事件 ===
  EVT_LONG_ANSWER_CREATED: "EVT_LONG_ANSWER_CREATED",
  EVT_LONG_ANSWER_CHUNK: "EVT_LONG_ANSWER_CHUNK",
  EVT_LONG_ANSWER_STATUS: "EVT_LONG_ANSWER_STATUS",
  EVT_LONG_ANSWER_COMPLETED: "EVT_LONG_ANSWER_COMPLETED",
  EVT_LONG_ANSWER_FAILED: "EVT_LONG_ANSWER_FAILED",
} as const;
...
export const DAG_WORKFLOW_EVENT_TYPE = {
  ...
  // === Level 1 并行：State 并行事件 ===
  PARALLEL_STEPS_DISPATCHED: 'EVT_DAG_PARALLEL_STEPS_DISPATCHED',
  STEP_COMPLETED: 'EVT_DAG_STEP_COMPLETED',
  STEP_FAILED: 'EVT_DAG_STEP_FAILED',
  STATE_JOIN_READY: 'EVT_DAG_STATE_JOIN_READY',
  // === Level 3 并行：Tool 并行事件 ===
  TOOLS_PARALLEL_DISPATCHED: 'EVT_DAG_TOOLS_PARALLEL_DISPATCHED',
  TOOL_BATCH_COMPLETED: 'EVT_DAG_TOOL_BATCH_COMPLETED',

  // === Phase 10：任务状态机与中断恢复事件 ===
  TASK_PAUSED: 'EVT_TASK_PAUSED',
  TASK_RESUMED: 'EVT_TASK_RESUMED',
  TASK_TIMEOUT: 'EVT_TASK_TIMEOUT',
  TASK_RECOVERY_STARTED: 'EVT_TASK_RECOVERY_STARTED',
  TASK_RECOVERY_COMPLETED: 'EVT_TASK_RECOVERY_COMPLETED',
  TASK_RECOVERY_FAILED: 'EVT_TASK_RECOVERY_FAILED',
} as const;
