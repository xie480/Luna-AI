...
const useSessionStore = create((set) => ({
  ...
  memory: null,
  // 设置当前会话 ID
  setSessionId: (id2) => set({ currentSessionId: id2 }),
  // 追加新消息
  ...
  // 更新消息内容（流式输出时使用）
  updateMessageChunk: (sessionId, msgId, chunk) => set((state) => {
    const sessionMessages = state.messages[sessionId] || [];
    const msgIndex = sessionMessages.findIndex((m2) => m2.messageId === msgId);
  ...
  // 更新消息状态
  updateMessageStatus: (sessionId, msgId, status) => set((state) => {
    const sessionMessages = state.messages[sessionId] || [];
    const msgIndex = sessionMessages.findIndex((m2) => m2.messageId === msgId);
    if (msgIndex === -1) return state;
    const updatedMessages = [...sessionMessages];
  ...
  // 更新任务节点状态
  updateNodeStatus: (nodeId, status, progress) => set((state) => {
    if (!state.activePlan) return state;
    const updatedNodes = state.activePlan.nodes.map(
      (node) => node.nodeId === nodeId ? { ...node, status, progress: progress ?? node.progress } : node
    );
    return {
      activePlan: {
        ...state.activePlan,
...
const useSystemStore = create((set) => ({
  ...
  addSystemLog: (log) => set((state) => ({
    systemLogs: [...state.systemLogs, `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] ${log}`]
  })),
  // 清空系统日志
...
class WSManager {
  ...
  handleMessage(msg) {
    ...
    switch (msgType) {
      ...
      case WS_MSG_TYPE.EVT_PLAN_SNAPSHOT:
        sessionStore.updatePlan(msg.payload);
        break;
      case WS_MSG_TYPE.EVT_NODE_STATUS_UPDATE:
        const nodePayload = msg.payload;
      ...
      case WS_MSG_TYPE.EVT_MEMORY_UPDATED:
        sessionStore.updateMemory(msg.payload);
        break;
  ...
  scheduleReconnect() {
    ...
    useSystemStore.getState().addSystemLog(
      `将在 ${delay / 1e3} 秒后尝试重连 (第 ${this.reconnectAttempts} 次)`
    );
...
const ChatView = () => {
  ...
  const renderMessage = (msg) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `message-bubble ${isUser ? "user-bubble" : "assistant-bubble"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-content", children: [
            msg.content,
            isStreaming && !isUser && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "streaming-cursor" })
          ] }),
          hasError && msg.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-error", children: [
            "错误: ",
            msg.error
          ] })
        ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-view", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "messages-container", children: [
      messages.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", children: "🌙" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-text", children: "开始与 Luna 对话吧..." })
      ] }) : messages.map(renderMessage),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: messagesEndRef })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-container-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `connection-indicator ${connectionStatus}`, children: [
...
const Sidebar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "sidebar-close", onClick: handleClose, children: "✕" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-content", children: [
      activeSidebarPanel === "dag" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel dag-panel", children: activePlan ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dag-view", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "plan-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: activePlan.goal }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "plan-id", children: [
            "ID: ",
            activePlan.planId
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nodes-list", children: activePlan.nodes.map((node) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `node-item ${node.status}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "node-header", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "node-name", children: node.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "node-status", children: node.status })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "node-description", children: node.description }),
              node.progress > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "node-progress", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              node.errorMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "node-error", children: node.errorMsg })
            ]
          },
          node.nodeId
        )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", children: "📊" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-text", children: "暂无活跃任务" })
      ] }) }),
      activeSidebarPanel === "memory" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel memory-panel", children: memory ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "memory-view", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "memory-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "角色设定" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "memory-list", children: memory.persona.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, index)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "memory-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "短期记忆" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "memory-list", children: memory.shortTerm.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, index)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "memory-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "长期记忆" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "memory-list", children: memory.longTermFacts.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, index)) })
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-icon", children: "🧠" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-text", children: "暂无记忆数据" })
      ] }) }),
      activeSidebarPanel === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel settings-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-view", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "系统设置" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-placeholder", children: "设置功能将在后续阶段实现..." })
      ] }) }),
      activeSidebarPanel === "logs" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel logs-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logs-view", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "系统日志" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logs-container", children: useSystemStore.getState().systemLogs.map((log, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "log-item", children: log }, index)) })
      ] }) })
    ] })
  ] }) });
};
const SidebarTrigger = () => {
  const openSidebar = useSystemStore.getState().openSidebar;
  const isSidebarOpen = useSystemStore((state) => state.isSidebarOpen);
  const [isMenuOpen, setIsMenuOpen] = React$2.useState(false);
  const handleOpenPanel = (panel) => {
    openSidebar(panel);
    setIsMenuOpen(false);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `sidebar-trigger-container ${isSidebarOpen ? "hidden" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `sidebar-menu ${isMenuOpen ? "open" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "main-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatView, {}) }),
